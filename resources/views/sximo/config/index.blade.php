...
<div class="page-header"><h2> Configuration <small> Mange basic  information and configuration for your application site  </small></h2></div>
 ...
 {!! Form::open(array('url'=>'sximo/config/save/', 'class'=>'form-horizontal form-material validated', 'files' => true)) !!}
<div class="card">
	<div class="card-body">
  	...
  	<div class="col-md-3">
  		<div style="text-align: center; padding-top: 30px;">
	            ...
	            <div class="custom-file fileUpload mb-3">
	              <input type="file" class="custom-file-input upload" id="logo" name="logo"  accept="image/x-png,image/gif,image/jpeg" >
