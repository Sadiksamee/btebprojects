...
{!! Form::open(array('url'=>'sximo/module/create/', 'class'=>'form-horizontal form-material validated', 'parsley-validate'=>'','novalidate'=>'')) !!}
<div class="row">
	...
	<div class="form-group row ">
		...
		<div class="col-sm-9">	
			...
			@foreach($cruds as $crud)
				...
				<input name="module_type"  type="radio" id="basic_checkbox_{{ $crud->type }}" value="{{ $crud->type }}"   />
