...
<div class="card">
	...
	<div class="col-md-6">
	{!! Form::open(array('url'=>'sximo/module/saveconfig/'.$module_name, 'class'=>'form-horizontal form-material','id'=>'configA' , 'parsley-validate'=>'','novalidate'=>' ')) !!}
 ...
 @if($type !='report' && $type !='generic')
  {!! Form::open(array('url'=>'sximo/module/savesetting/'.$module_name, 'class'=>'form-horizontal form-material ' ,'id'=>'configB')) !!}
