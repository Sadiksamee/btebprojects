...
<div class="page-header"><h2> Module Packager <small> Create Package Installer </small> </h2></div>
  ...
  <div class="panel-default panel">
    ...
    <ul class="parsley-error-list">
     ...
     {!! Form::open(array('url'=>'sximo/module/dopackage', 'class'=>'form-horizontal form-material','files' => true , 'parsley-validate'=>'','novalidate'=>' ')) !!}
     <div class="row">
          <div class="col-md-6">
              <div class="header" >
              ...
              <div class="content col-md-12" >
                ...
                <div class="form-group  " >
                  ...
                  <div class="" >
                    <input type="checkbox" name="file_library[]" value="{{ $file }}" id="{{ $file }}">
                ...
                <div class="form-group  " >
                  ...
                  <div class="" >
                    <input type="checkbox" name="file_lang[]" value="{{ $file }}" id="{{ $file }}">
                    <label for="{{ $file }}">{!! $file !!} </label>
                  </div>
                    @endforeach
                </div>           
