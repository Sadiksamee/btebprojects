...
<div class="ajaxLoading"></div>
	...
	<div class="form-signin">
		...
		<div id="tab-sign-in" class="authentication-form">
	 		...
	 		{!! Form::open(array('url'=>'user/signin', 'class'=>'form-material','id'=>'LoginAjax' , 'parsley-validate'=>'','novalidate'=>' ')) !!}
			...
			<div class="animated fadeInUp delayp1">
				<div class="form-group  ">
					...
					<div style="padding:15px 0; text-align: center;">
						...
						<a href="{{ url('user/socialize/facebook')}}" class="btn btn-circle btn-success"><i class="ti-facebook"></i> </a>
						@endif
						@if($socialize['google']['client_id'] !='') 
						<a href="{{ url('user/socialize/google')}}" class="btn btn-circle btn-danger"><i class="ti-google"></i> </a>
						@endif
						@if($socialize['twitter']['client_id'] !='') 
						<a href="{{ url('user/socialize/twitter')}}" class="btn btn-circle  btn-info"><i class="ti-twitter"></i> </a>
						@endif
					</div>
					@endif
				</div>	
		...
		<div class=" m-t" id="tab-forgot" style="display: none">				
			{!! Form::open(array('url'=>'user/request', 'class'=>'form-vertical form-material', 'parsley-validate'=>'','novalidate'=>' ')) !!}
