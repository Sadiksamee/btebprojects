...
class CurriculumController extends Controller {
	...
	public static function display(  )
	{
		...
		$info = $model::makeInfo('curriculum');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('curriculum.public.view',$data);			
			}			
		} 
		else {
			...
			return view('curriculum.public.index',$data);	
		}
